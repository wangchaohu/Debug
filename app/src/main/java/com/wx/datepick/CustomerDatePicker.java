...
public class CustomerDatePicker {
    ...
    private boolean isBottom = true; //是否在底部
    private Dialog datePickerDialog;
    private DatePickView year_pv, month_pv, day_pv, hour_pv, minute_pv;
    ...
    public CustomerDatePicker(Context context, ResultHandler resultHandler, String startDate, String endDate, boolean isBottom) {
    ...
    private void initView() {
        year_pv = (DatePickView) datePickerDialog.findViewById(R.id.year_pv);
        month_pv = (DatePickView) datePickerDialog.findViewById(R.id.month_pv);
        day_pv = (DatePickView) datePickerDialog.findViewById(R.id.day_pv);
        hour_pv = (DatePickView) datePickerDialog.findViewById(R.id.hour_pv);
        minute_pv = (DatePickView) datePickerDialog.findViewById(R.id.minute_pv);
    ...
    private void addListener() {
        year_pv.setOnSelectListener(new DatePickView.onSelectListener() {
            @Override
        ...
        month_pv.setOnSelectListener(new DatePickView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        day_pv.setOnSelectListener(new DatePickView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        hour_pv.setOnSelectListener(new DatePickView.onSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        minute_pv.setOnSelectListener(new DatePickView.onSelectListener() {
            @Override
            public void onSelect(String text) {
